    ...
    return (
        <>
            ...
            <div className="fixed inset-0 bg-gray-800 sm:bg-black/80 z-40 flex items-center justify-center">
                <X className='absolute right-10 top-10 cursor-pointer text-red-800 scale-200 transition-all' onClick={() => setShowKeyInputBox(!showKeyInputBox)} />
                ...
                <div className="bg-gray-800 shadow-lg rounded-2xl p-8 w-full max-w-md text-white">
                    ...
                    <p className="text-sm text-gray-300 mb-6 text-center">
                        To use AI movie recommendations, you need an OpenAI API key.
