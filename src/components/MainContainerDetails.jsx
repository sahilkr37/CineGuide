...
function MainContainerDetails({ mainMovieId }) {
    ...
    return (
        <div className="absolute top-1/3 sm:left-20 left-2 z-20 text-white max-w-xs sm:max-w-xl pointer-events-none">
            {/* Title */}
            <h1 className="text-lg sm:text-4xl md:text-4xl font-extrabold drop-shadow-lg leading-tight">
                {mainMovie.title}
            </h1>
            ...
            <div className="mt-4 sm:mt-6 flex flex-wrap gap-2 sm:gap-4 pointer-events-auto">
                <button className="bg-white cursor-pointer text-black px-2 sm:px-4 md:px-2 py-1 sm:py-2 rounded-md text-xs sm:text-base font-semibold hover:bg-gray-200">
                    ▶ Play Trailer
                </button>
                <button
